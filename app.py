...
st.title("⚡ SPICEN TECH")
st.subheader("Universal ECE Architectural Engine v6.0")
...
if st.button("Generate Complete Lab Report"):
    if user_input:
        ...
        if report:
            ...
            st.caption("Engine System Status: Operational 24/7 | Spicen Tech Academic Framework Pipeline")